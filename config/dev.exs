...
config :holz_log, HolzLog.Repo,
  database: Path.expand("../holz_log_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :holz_log, HolzLogWeb.Endpoint,
  ...
  check_origin: [
    "https://holzlog.duckdns.org",
    "https://holzlog.vossihub.com",
    "//localhost:4000"
  ],
  code_reloader: true,
  debug_errors: true,
...
config :holz_log, HolzLogWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/holz_log_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :holz_log, dev_routes: true
