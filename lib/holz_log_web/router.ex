defmodule HolzLogWeb.Router do
  ...
  scope "/", HolzLogWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{HolzLogWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", HolzLogWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{HolzLogWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", HolzLogWeb do
    ...
    live_session :current_user,
      on_mount: [{HolzLogWeb.UserAuth, :mount_current_user}] do
